...
import Trips from './karavaan/trips';
import TripInfo from './karavaan/tripinfo';
import Expense from './karavaan/expense';
...
const AppNavigator = StackNavigator(
  {
    // Karavaan
    KaravaanDrawer: { screen: KaravaanDrawer },
    /*
    Trips: { screen: Trips },
  ...
  {
    initialRouteName: 'KaravaanDrawer', // "Drawer",
    headerMode: 'none',
  },
);
